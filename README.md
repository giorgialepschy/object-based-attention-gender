...
To replicate the analysis, please use RStudio, open the file “AGGIORNARE NOME FILE CODICE” and execute the code. Importing the dataset file manually will not be necessary as the code automatically retrieves it from OSF (this will require an internet connection).
